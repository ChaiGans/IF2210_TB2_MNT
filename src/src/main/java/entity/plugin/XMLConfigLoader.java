...
//            GameState loadedGameState = loader.loadGameState(gameStatePath, player1Path, player2Path);
...
//            loader.saveGameState(loadedGameState, gameStatePath, player1Path, player2Path);
